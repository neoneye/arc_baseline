...
MEMORY_LIMIT = int(mem_limit * 1024 * 0.95) # MB
TIME_LIMIT   = int(9*60*60 * 0.95) # Seconds

if LOCAL: # local
    # MEMORY_LIMIT = 3*4096 * 0.95 # MB
    TIME_LIMIT   = int(2*60 * 0.95) # Seconds
    pass
else:
    pass # 24 hours of 15GB RAM and 4 cpu

print("SETTINGS:", MEMORY_LIMIT, TIME_LIMIT)
...
for taski in task_list:
    ...
    if len(ids) != 1:
        print(f"Unable to solve task {taski}")
        continue
